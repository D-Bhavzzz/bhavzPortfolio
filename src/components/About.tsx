      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            I am a B.Com (Professional) graduate with an integrated Chartered Accountancy background,
            offering a solid foundation in accounting, finance, and taxation. With strong analytical skills
            and a detail-oriented approach to financial and tax problem-solving, I am eager to contribute
            effectively in a dynamic professional environment.
          </p>
        </div>
